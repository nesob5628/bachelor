...
import { describe, beforeEach } from "node:test";
  ...
  test("should remove completed video progress correctly", () => {
    ...
    test("should calculate 100% progress under one theme when all videos are completed", () => {
      const videoIds = ["46623012-eb25-4ed7-abd0-2600205c214c", "2d37ce0f-b99d-4739-a76f-4bc5f967a98c", "d4959ea3-d3dc-4e0b-906e-514489265c28", "d68a8ba6-4e56-44a8-8d43-3150d99fb5bc"];
